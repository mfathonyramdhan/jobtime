...
<body style="padding-top: 20px;">
	...
	<nav class="navbar bg-primary navbar-expand fixed-bottom " style="height: 40px; padding: 0px;">
		...
		<!-- <div class="row" style="margin-right: 20px; margin-left: 20px; padding-bottom: 20px;"><label for="first-name-column">Cari Loker</label>
		<input class="form-control" id="myInput" type="text" placeholder="Masukan Kata Kunci..."> -->

			<form action="<?= base_url('user/search') ?>" method="get" style="margin-right: 20px; margin-left: 20px; padding-bottom: 20px;">
				<div class="input-group">
						<span class="input-group-text" id="basic-addon1"><i class="bi bi-search"></i></span>
						<input type="text" class="form-control" placeholder="Masukan Kata Kunci..." aria-label="Recipient's username" aria-describedby="button-addon2">
	...
	<?php if(!empty($keyword)){ ?>
		<p style="color:purple"><b>Menampilkan data dengan kata kunci : "<?= $keyword; ?>"</b></p>
	<?php } ?>
