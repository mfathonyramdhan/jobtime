<body>
	...
	<nav class="navbar bg-primary navbar-expand fixed-bottom shadow" style="height: 40px; padding: 0px;">
		<ul class="navbar-nav nav-justified w-100">
			<li class="nav-item" style="background-color: white;">
				<a href="<?= base_url('user/myloker/') ?>" class="nav-link">
	...
	<div class="" style="margin: 0px 0px 30px 0px; padding-top: 30px;">

		<?php if (count($loker_user) > 0) { ?>
			<div class="row mx-2" style="padding-top: 30px;">
			...
			<?php } else { ?>
				...
				<div class="text-center my-auto" style="margin: 20px; padding-bottom: 20px; padding-top: 80px;">
					<img class="card-img-top img-fluid" src="<?php echo base_url('assets/images/samples/error-404.png') ?>" alt="Card " style="width: 30%" />
